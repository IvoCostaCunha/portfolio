...
export class PortfolioComponent implements OnInit {
  ...
  websiteData: WebsiteData = {
    ...
    mePhotoPath: "assets/imgs/site/me/me.jpg",
    aboutMeHTML: `
      ...
      I appreciate to learn and experience new things so I like to change subjects on my personal projects in way to not work on the same type of project twice in a row. That gives me a way to extend my knowledge and be more polyvalent.<br>
    ...
    workMethodsHTML: `
      ...
      I am looking for opportunities as a freelance, so if you think I can code something for you do no hesitate to contact me.<br>
      You can check my projects in the section <a href="#projects">Projects</a> bellow.
    `,
    beliefsHTML: `
    ...
    projects: [
      ...
      },
      {
        ...
        gitlabLink: "https://gitlab.com/ivo-costacunha/portfolio.git",
        doc: "",
